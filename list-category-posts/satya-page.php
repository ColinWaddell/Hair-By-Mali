...
$lcp_display_output .= '<div class="row"><ul class="satya-list-page">';
...
foreach ($this->catlist->get_categories_posts() as $single):
    ...
    $lcp_display_output .= "<li class='span12'><div class='row entry-content'>";

    //Show the title and link to the post:
    $lcp_display_output .= '<h2>'.$single->post_title.'</h2>';
    $lcp_display_output .= "<div class='span3'>";
    //Post Thumbnail
    //$lcp_display_output .= $this->get_thumbnail($single)
    $lcp_display_output .= get_the_post_thumbnail(
                                                   $single->ID,
                                                   'thumbnail' 
                                                 );

    $lcp_display_output .= "</div><div class='span8'>";
    ...
    //Close li tag
    $lcp_display_output .= '</div></div></li>';
endforeach;

$lcp_display_output .= '</ul></div>';
