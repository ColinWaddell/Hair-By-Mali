...
function roots_scripts() {
  wp_enqueue_style('roots_bootstrap', get_template_directory_uri() . '/assets/css/less/bootstrap.css', false, null);
  ...
  wp_enqueue_style('roots_fonts', get_template_directory_uri() . '/assets/css/fonts/fonts.css', false, null);
